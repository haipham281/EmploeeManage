...
<body>
        ...
        <div class="container-fluid fixed-top bg-light">
            ...
            <nav class=" navbar  navbar-expand-lg">
                ...
                <div id="my-nav" class="collapse navbar-collapse col-9">
                    <h1 class="col-8">Department Manager</h1>
                </div>
            </nav>
        </div>
    ...
    <div style="margin-left: 30px; margin-right: 30px;">
        <div>
            <a href="department_add.php" class=" btn btn-primary" style="margin-left: 3px;">Add</a>
        ...
        <table class="table " style="margin-top: 18px;">
            ...
            while($row = mysqli_fetch_array($result)) { ?>
                <tr><td align="center"><?php echo $count; ?></td>
                    <td align="center"><?php echo $row["department_number"]; ?></td>
                    <td align="center"><?php echo $row["department_name"]; ?></td>
                    <td align="center"><?php echo $row["department_head"]; ?></td>
                    <td align="center"><?php echo $row["employee"]; ?></td>
                    <td align="center"><?php echo $row["description"]; ?></td>
                    <td align="center">
                        <a class="btn btn-primary" href="department_edit.php?id=<?php echo $row["id"];  ?>">Edit Department</a>
                    </td>
                    <td align="center">
                        <a class="btn btn-dark" href="department_delete.php?id=<?php echo $row["id"]; ?>" onclick="return confirm('Are you sure?')">Delete Department</a>
                    </td>
                </tr>
